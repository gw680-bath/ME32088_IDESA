...
IDESA_Comms_3.py
UDP comms:
- Sends three float32 (distance_mm, angle_deg, state_flag) as struct '<3f'
...
class UDPComms3:
    ...
    def _send(self, dist_mm: float, ang_deg: float, state_flag: float) -> None:
        self.ensure_socket()
